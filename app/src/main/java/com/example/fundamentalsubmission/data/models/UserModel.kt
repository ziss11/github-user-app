...
data class UserModel(
    ...
    @field: SerializedName("bio") val bio: String? = null,

    @field: SerializedName("followers") val followers: Int = 0,

    @field: SerializedName("following") val following: Int = 0,

    @field: SerializedName("public_repos") val publicRepos: Int = 0,
)